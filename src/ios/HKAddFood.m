...
- (void) saveFoodItem:(CDVInvokedUrlCommand*)command {
    ...
    NSSet* nutritionTypes = [NSSet setWithObjects:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryEnergyConsumed],
		...
		HKQuantitySample* Caffeine = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryCaffeine] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodCaffeine] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Calcium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryCalcium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodCalcium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Carbohydrates = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryCarbohydrates] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodCarbohydrates] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Chloride = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryChloride] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodChloride] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Cholesterol = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryCholesterol] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodCholesterol] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Chromium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryChromium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodChromium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Copper = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryCopper] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodCopper] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* FatMonounsaturated = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFatMonounsaturated] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodFatMonounsaturated] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* FatPolyunsaturated = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFatPolyunsaturated] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodFatPolyunsaturated] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* FatSaturated = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFatSaturated] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodFatSaturated] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* FatTotal = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFatTotal] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodFatTotal] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Fiber = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFiber] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodFiber] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Folate = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryFolate] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodFolate] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Iodine = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryIodine] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodIodine] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Iron = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryIron] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodIron] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Magnesium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryMagnesium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodMagnesium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Manganese = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryManganese] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodManganese] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Molybdenum = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryMolybdenum] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodMolybdenum] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Niacin = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryNiacin] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodNiacin] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* PantothenicAcid = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryPantothenicAcid] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodPantothenicAcid] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Phosphorus = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryPhosphorus] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodPhosphorus] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Potassium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryPotassium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodPotassium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Protein = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryProtein] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodProtein] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Riboflavin = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryRiboflavin] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodRiboflavin] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Selenium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietarySelenium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodSelenium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Sodium = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietarySodium] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodSodium] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Sugar = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietarySugar] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnit] doubleValue:foodSugar] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Thiamin = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryThiamin] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodThiamin] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminA = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminA] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodVitaminA] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminB12 = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminB12] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodVitaminB12] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminB6 = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminB6] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodVitaminB6] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminC = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminC] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodVitaminC] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminD = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminD] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodVitaminD] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminE = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminE] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodVitaminE] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* VitaminK = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryVitaminK] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMicro] doubleValue:foodVitaminK] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
		HKQuantitySample* Zinc = [HKQuantitySample quantitySampleWithType:[HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierDietaryZinc] quantity:[HKQuantity quantityWithUnit:[HKUnit gramUnitWithMetricPrefix:HKMetricPrefixMilli] doubleValue:foodZinc] startDate:timeFoodWasConsumed endDate:timeFoodWasConsumed metadata:metadata];
